package com.huyong.dao.util.utils;
...
public class BuilderUtils {
     ...
     * @return
     */
    public static String getTableFiledFragment(Class<?> clazz, String prefix) {
        StringBuilder fragment = new StringBuilder();
        Field[] fields = clazz.getDeclaredFields();
        for (Field field : fields) {
            if (ignoreField(field)) {
    ...
    public static String getInsertColumnsFragment(Class<?> clazz) {
        return clazz.getSimpleName() + "_insert_columns_fragment";
    }

    public static String getInsertValuesFragment(Class<?> clazz) {
        return clazz.getSimpleName() + "_insert_values_fragment";
    }
}
