...
public class DeleteByPrimaryGenerate extends AbstractSqlGenerate {
    ...
    public void genIbatisSql(Class<?> clazz) {
        getBuilderResult().append("<delete id =\"").append(BuilderUtils.getStatement(clazz)).append(".").append(AbstractSqlGenerate.DELETE_BY_PRIMARY).append("\" parameterType=\"long\" >");
