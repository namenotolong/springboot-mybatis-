...
public class BatchInsertGenerate extends AbstractSqlGenerate {
    ...
    public void genIbatisSql(Class<?> clazz) {
        ...
        sql.append("<insert id =\"").append(BuilderUtils.getStatement(clazz)).append(".").append(AbstractSqlGenerate.BATCH_INSERT).append("\"").append(" useGeneratedKeys=\"true\" keyProperty=\"id\" parameterType=\"list\" >");
