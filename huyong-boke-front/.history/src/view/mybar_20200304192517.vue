        ...
        <el-form  :model="ruleForm" status-icon :rules="rules" ref="ruleForm"  class="demo-ruleForm">
          ...
          <el-form-item prop="validateCode">
            <div style="display:flex;justify-content:space-between">
              ...
              <div>
                <span @click="getcode = true" v-if="!getcode">获取验证码</span>
              </div>
           </div>
          </el-form-item>
          <el-form-item prop="password" v-if="getcode">
            <el-input placeholder="密码" type="password" v-model="ruleForm.password" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button v-if="getcode" type="primary" @click="submitForm('ruleForm')">注册</el-button>
