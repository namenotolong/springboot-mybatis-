  ...
  <div>
    ...
    <div>
      <el-container style="height: 600px; border: 1px solid #eee">
        <el-aside width="150px" style="background-color: #3d3d3d">
         <div class="out-kind">
           <div class="item">
             <div class="text-container">
               <span class="kind-text">全部分类</span>
             </div>
             <div class="text-container">
               <span class="kind-text">java</span>
             </div>
             <div class="text-container">
               <span class="kind-text">c#</span>
             </div>
             <div class="text-container">
               <span class="kind-text">全部分类</span>
             </div>
                ...
                <div class="content" >
                  ...
                  <div class="detail">
                    <div class="user myflex">
                      ...
                      <div style="margin-left: 15%" @click="goOwn(item.user.id)">
