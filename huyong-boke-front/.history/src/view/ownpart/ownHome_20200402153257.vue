      ...
      <el-container style="height: 600px; ">
        <el-aside width="100px" style="background-color: rgb(238, 241, 246)">
          <div class="article-data">
            <div @click="praise">
              <svg v-if="praised" style="width: 50%;height:50%" t="1585143730331" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5311" width="200" height="200"><path d="M621.674667 408.021333c16.618667-74.24 28.224-127.936 34.837333-161.194666C673.152 163.093333 629.941333 85.333333 544.298667 85.333333c-77.226667 0-116.010667 38.378667-138.88 115.093334l-0.586667 2.24c-13.728 62.058667-34.72 110.165333-62.506667 144.586666a158.261333 158.261333 0 0 1-119.733333 58.965334l-21.909333 0.469333C148.437333 407.808 106.666667 450.816 106.666667 503.498667V821.333333c0 64.8 52.106667 117.333333 116.394666 117.333334h412.522667c84.736 0 160.373333-53.568 189.12-133.92l85.696-239.584c21.802667-60.96-9.536-128.202667-70.005333-150.186667a115.552 115.552 0 0 0-39.488-6.954667H621.674667z" p-id="5312" fill="#d81e06"></path></svg>
          ...
          <div class="out-container">
            <div class="user-container">
              ...
              <div v-if="other.id != user.id">
                <div>
                  <el-button type="danger" @click="chat">私信</el-button>
                ...
                <div v-if="handleNum == 7">
                  ...
                  <div class="ducument-container">
                    <el-form ref="tempUser" :rules="rules" :model="tempUser" label-width="80px" class="form-data">
                      ...
                      <el-form-item label="性别:">
                        <span v-if="tempUser.gender">女</span>
                        <span v-else>男</span>
                      </el-form-item>
                      <el-form-item label="简介:">
...
export default {
  ...
  methods: {
    ...
    chat() {
      ...
      this.$axios.get("/history/add?id=" + this.other.id).then(response => {
        loading.close()
    ...
    //获取点赞的数目
    getPraiseCount() {
      this.$axios.get("/relation/getPraised", {
        params : {
          id : this.$route.params.id
        }
      }).then(response => {
        this.praised = response.data.data.praised
