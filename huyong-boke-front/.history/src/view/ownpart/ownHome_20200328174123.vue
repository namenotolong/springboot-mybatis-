  ...
  <div>
    ...
    <div class="out-container">
      ...
      <div class="kind-container">
        ...
        <div v-if="handleNum == 2">
          <div class="infinite-list-wrapper main-content" style="overflow:auto" >
            <div
              class="list"
              v-infinite-scroll="getTopics" infinite-scroll-immediate="this.other.id" infinite-scroll-disabled="topicDisabled"  style="overflow:auto">
               <div v-for="item in topics" :key="item.id" class="segment">
                <div class="content" @click="goView">
                  <div class="title">
                    <h4>{{item.content}}</h4>
                  </div>
                  <div class="detail">
