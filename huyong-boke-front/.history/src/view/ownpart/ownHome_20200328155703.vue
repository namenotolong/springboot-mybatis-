      ...
      <div class="kind-container">
        ...
        <div>
          <div class="infinite-list-wrapper main-content" style="overflow:auto" >
            <div
              class="list"
              v-infinite-scroll="getArticles" infinite-scroll-disabled="disabled">
            ...
            <p v-if="articleMore && articleLoading">加载中...</p>
            <p v-if="!articleMore">没有更多了...</p>
            </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    disabled () {
      return this.articleLoading || !this.articleNoMore
    }
  },
}
</script>
