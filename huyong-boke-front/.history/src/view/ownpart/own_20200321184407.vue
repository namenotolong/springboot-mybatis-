        ...
        <el-form ref="form" :model="user" label-width="80px" class="form-data">
          <el-form-item>
            <div class="bar-picture">
              ...
              <input type="file" id="file" class='barfile'>
              <div style="margin-left:5%">
                <a><input type="file" id="file" class='barfile'>更换头像</a>
                <el-button type="success" @click="changeBar">更换头像</el-button>
              </div>
              <div>
                <span class="fileinput-button ">123
