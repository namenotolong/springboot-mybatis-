      ...
      <div class="user-container">
        ...
        <div>
          <div >
            ...
            <el-button v-if="other.follow">取消关注</el-button>
      ...
      <div class="kind-container">
        ...
        <div>
          <div v-if="handleNum == 3">
            <div v-for="(item, key) in follows" :key="item.id">
              {{item}}
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getFollowsOrFans(type) {
      this.$axios.get("/relatioin/getFansOrFollows", {
        params : {
