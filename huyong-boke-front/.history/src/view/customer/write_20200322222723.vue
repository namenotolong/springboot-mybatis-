        ...
        <div>
          <el-menu class="el-menu-demo" mode="horizontal">
            <el-submenu index="1" >
              ...
              <el-menu-item :index="item.id"  v-for="item in kinds" :key="item.id" @click="handleEdit(item.kindName)">
                ...
                <el-submenu :index="item.id" v-else>
                  ...
                  <el-menu-item :index="child.id" v-for="child in item.children" :key="child.id">{{child.kindName}}</el-menu-item>
                </el-submenu>
              </el-menu-item>
            </el-submenu>
          </el-menu>
