<template>
  <div>
    ...
    <el-container>
        ...
        <el-footer>
          <div>
            <el-input style="width:80%" placeholder="写下你的评论……" v-model="commonContent"></el-input>
            <el-button type="warning" v-if="commonContent.trim().length > 0">发表</el-button>
            <el-button type="warning" v-else>发表</el-button>
          </div>
        </el-footer>
      </el-container>
    </el-container>
