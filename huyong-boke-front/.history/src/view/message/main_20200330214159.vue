              ...
              <div v-if="index == 1">
                ...
                <div class="reply-container" v-for="(item, key) in replies" :key="item.id">
                  <div class="myflex-between">
                    ...
                    <div>
                        <el-link><span class="date-style">回复</span></el-link>
                    </div>
                  </div>
                  <div>
                  ...
                  <div class="myflex" v-if="item.willReply">
                    <div style="width: 200%">
                          <el-input
                          style="width: 600px"
                          type="text"
                    ...
                    <div>
                      <el-button round type="success" :disabled="!item.willReply || item.willReply.trim().length === 0">回复</el-button>
                    </div>
                    <div>
