                ...
                <div class="reply-container" v-for="(item, key) in replies" :key="item.id">
                  <div class="myflex">
                    ...
                    <div style="margin-left: 10px">
                      <div>
                        <el-link type="primary" @click="goOwn(user.id)"><b class="user">{{item.userName}}</b></el-link>
                      </div>
                      <div>
                  ...
                  <div v-if="!item.topicId">
                   <el-link type="primary"><b class="user">{{user.userName}}</b></el-link><span>:&nbsp;{{item.replyContent}}</span>
                  </div>
                  <div>
                    <span><span class="date-style">博文：</span><b><el-link type="info">{{item.title}}</el-link></b></span>
                  </div>
                  <div>
                    <div>
                      <span></span>
